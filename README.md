...
지운 단어·책·책갈피가 다음 동기화에 되살아나지 않습니다. 같은 것을 다시 넣으면 무덤에서 꺼냅니다.
...
- **책갈피** — 툴바 **🔖** 로 지금 쪽을 저장하고, 사이드바 목록에서 눌러 그 자리로. 기기끼리 동기화됩니다
...
- **5가지 테마** (베이지 / 화이트 / 세피아 / 잿빛 / 블랙) — 머리말 오른쪽의 **색 동그라미**를 눌러 바로 바꿉니다
- **글꼴** — 세리프·고딕·Palatino 에 더해 한글 본문용으로 리디바탕·본명조·고운바탕·바른고딕·프리텐다드, 글자 크기 조절
